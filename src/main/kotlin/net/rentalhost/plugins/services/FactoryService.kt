...
object FactoryService {
    ...
    fun createParameterList(project: Project, parameters: String): PsiElement =
        PhpPsiElementFactory.createPhpPsiFromText(project, ParameterList::class.java, "fn($parameters){}")
